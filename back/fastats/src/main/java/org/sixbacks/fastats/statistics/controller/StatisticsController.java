...
public class StatisticsController {
	...
	public ResponseEntity<ApiResponse<List<StatTableListResponse>>> getStatTableList(@RequestParam String keyword,
		@RequestParam int page, @RequestParam int size, @RequestParam String ctg) {
